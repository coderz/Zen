...
var handleErrors = function handleErrors(json, err, res, body, callback) {
  var errors = [400, 404, 503, 415, 412, 500];
  if(err || ~errors.indexOf(res.statusCode))
    return callback(err || new Error(codes[res.statusCode]));
